...
// 临时占位图标，避免缺失模块导致构建失败，后续可替换为真实图标组件
const LogoIcon = {
  render() {
...
const TrendUpIcon = LogoIcon
const TrendDownIcon = LogoIcon
const CheckCircleIcon = LogoIcon
const AlertCircleIcon = LogoIcon
const InfoCircleIcon = LogoIcon
const XCircleIcon = LogoIcon
