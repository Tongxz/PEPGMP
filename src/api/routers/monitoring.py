...
async def health_check() -> Dict[str, Any]:
    ...
    try:
        ...
        all_ok = all(
            ...
            if k not in ["consistency_issues", "consistency_details", "consistency_error"]
        )
...
def record_request(status_code: int, domain_service_used: bool = False, response_time_ms: float = 0.0):
    """记录请求指标.
    ...
    _metrics["requests_by_status"][status_str] = _metrics["requests_by_status"].get(status_str, 0) + 1
