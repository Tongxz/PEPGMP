...
async def get_system_config() -> Dict[str, Any]:
    ...
    try:
        ...
        config_files = {
            ...
            "unified_params": os.path.join(project_root, "config", "unified_params.yaml"),
            "enhanced_detection": os.path.join(project_root, "config", "enhanced_detection_config.yaml"),
        }
...
async def get_system_health() -> Dict[str, Any]:
    ...
    try:
        ...
        # 检查关键目录
        critical_dirs = [
            "config", "src", "models", "data", "frontend"
        ]
        ...
        # 检查关键文件
        critical_files = [
            "requirements.txt", "main.py", "config/default.yaml"
        ]
