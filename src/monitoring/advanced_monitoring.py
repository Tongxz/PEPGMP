...
class MonitoringDashboard:
    ...
    def get_dashboard_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "health_score": self._calculate_health_score(system_metrics, app_metrics, alert_status)
        }
    ...
    def _get_metric_summary(self, metric_name: str) -> Dict[str, Any]:
        ...
        return {
            "current": latest.value if latest else 0,
            "stats": stats
        }
    
    def _calculate_health_score(self, system_metrics: Dict, app_metrics: Dict, alert_status: Dict) -> int:
        """计算健康分数"""
        score = 100
