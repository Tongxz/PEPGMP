        ...
        with self.lock:
            ...
            if frame_id not in self.frame_metadata_manager.frame_index:
                ...
                with self.frame_metadata_manager.lock:
                    ...
                    # 时间戳索引
                    timestamp_key = self.frame_metadata_manager._round_timestamp(frame_meta.timestamp)
                    ...
                    self.frame_metadata_manager.timestamp_index[timestamp_key].append(frame_id)
