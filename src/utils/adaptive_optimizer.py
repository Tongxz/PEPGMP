...
class AdaptiveOptimizer:
    ...
    def detect_hardware_tier(self) -> str:
        ...
        # RTX 40系列和高端30系列
        if any(x in gpu_name for x in ["rtx 4090", "rtx 4080", "rtx 3090", "rtx 3080 ti"]) or vram_gb >= 20:
            return "flagship_gpu"
        
        # 中高端GPU
        elif any(x in gpu_name for x in ["rtx 4070", "rtx 4060 ti", "rtx 3070", "rtx 3060 ti"]) or vram_gb >= 8:
            return "high_end_gpu"
        
        # 中端GPU
        elif any(x in gpu_name for x in ["rtx 3060", "rtx 2060", "gtx 1660"]) or vram_gb >= 4:
    ...
    def get_optimization_config(self, user_profile: Optional[str] = None) -> Dict[str, Any]:
        """获取优化配置"""
        # 用户可以手动指定配置档位
