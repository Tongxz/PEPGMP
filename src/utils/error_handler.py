...
class ErrorRecoveryStrategy:
    ...
    def __init__(self):
        self.strategies: Dict[ErrorCategory, List[Callable]] = {
            ...
            ErrorCategory.MODEL: [self._recovery_model_reload, self._recovery_model_fallback],
            ErrorCategory.GPU: [self._recovery_gpu_fallback, self._recovery_cpu_mode],
            ErrorCategory.NETWORK: [self._recovery_network_retry, self._recovery_offline_mode],
            ErrorCategory.DATABASE: [self._recovery_db_retry, self._recovery_db_fallback],
            ErrorCategory.FILE_IO: [self._recovery_file_retry, self._recovery_temp_file],
            ErrorCategory.TIMEOUT: [self._recovery_timeout_retry, self._recovery_timeout_extend],
            ErrorCategory.RESOURCE: [self._recovery_resource_cleanup, self._recovery_resource_wait],
        }
...
class UnifiedErrorHandler:
    ...
    def get_error_report(self) -> Dict[str, Any]:
        ...
        # 添加健康状态评估
        critical_errors = self.error_tracker.get_errors_by_severity(ErrorSeverity.CRITICAL)
