...
from src.database.connection import get_async_session, init_database
        ...
        try:
            ...
            deployments = [
                {
                    ...
                    "deployment_config": {
                        ...
                        "env": [
                            {
                                "name": "MODEL_PATH",
                                "value": "/app/models/yolo_human.pt",
                            },
                ...
                },
                {
                    ...
                    "deployment_config": {
                        ...
                        "env": [
                            {
                                "name": "MODEL_PATH",
                                "value": "/app/models/yolo_hairnet.pt",
                            },
            ...
            workflows = [
                ...
                },
                {
                    ...
                    "avg_duration": 12.0,
                    "last_run": datetime.utcnow(),
                    "workflow_config": {"timeout": 1800, "retry_count": 2},
                },
            ]
